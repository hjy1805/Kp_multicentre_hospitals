...
acc=$(awk -F '[\t]' '{print $0}' mm_b3_add.txt | awk "NR == $SLURM_ARRAY_TASK_ID")

amrfinder --nucleotide ./${acc}/assembly_unicycler/assembly.fasta -O Klebsiella_pneumoniae --plus -o ./${acc}/${acc}_amrfinder.tsv
